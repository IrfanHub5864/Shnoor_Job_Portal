...
const createAvatarDataUrl = (fullName) => {
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="240" height="240" viewBox="0 0 240 240" fill="none">
      ...
      <text x="120" y="126" fill="#ffffff" font-family="Arial, Helvetica, sans-serif" font-size="54" font-weight="700" text-anchor="middle" dominant-baseline="middle">${initials}</text>
    </svg>
  `;
      ...
      <div className={styles.pageShell}>
        ...
        <div className={styles.heroCard}>
          ...
          <div className={styles.heroContent}>
            <div>
              ...
              <h2>{isEditing ? (draft.fullName || profile.fullName) : profile.fullName}</h2>
        ...
        <div className={styles.sectionGrid}>
          ...
          <section className={styles.card}>
            ...
            <div className={styles.formGrid}>
              ...
              <div className={`${styles.fieldGroup} ${styles.fullWidth}`}>
                ...
                <textarea id="skills" name="skills" rows="4" value={draft.skills} onChange={handleDraftChange} disabled={!isEditing} />
          ...
          <section className={styles.card}>
            <div className={styles.cardHeader}>
              <h3>Security</h3>
              <span className={styles.sectionNote}>Update your password</span>
            </div>

            <div className={styles.securityGrid}>
              <div className={`${styles.fieldGroup} ${styles.fullWidth}`}>
                <label className={styles.fieldLabel} htmlFor="currentPassword">Current Password</label>
                <input id="currentPassword" name="currentPassword" type="password" value={passwordForm.currentPassword} onChange={handlePasswordFieldChange} />
              </div>
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel} htmlFor="newPassword">New Password</label>
                <input id="newPassword" name="newPassword" type="password" value={passwordForm.newPassword} onChange={handlePasswordFieldChange} />
              </div>
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel} htmlFor="confirmPassword">Confirm New Password</label>
                <input id="confirmPassword" name="confirmPassword" type="password" value={passwordForm.confirmPassword} onChange={handlePasswordFieldChange} />
              </div>
            </div>
          ...
          <section className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <span className={styles.sectionNote}>Readonly account metadata</span>
            </div>
